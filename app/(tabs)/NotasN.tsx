...
import { getAllNotes, getNotesByType, initDatabase, Note, deleteNote } from '../../services/database';
              ...
              <View style={[styles.container, { paddingBottom: v(30) }]}>
                ...
                <View style={[styles.listCard, {
                  ...
                  {loading ? (
                    ...
                    <View style={{ paddingVertical: v(40), alignItems: 'center' }}>
                      <Text style={{ color: "#888888", fontSize: s(14) }}>No hay notas</Text>
                      <Text style={{ color: "#666666", fontSize: s(12), marginTop: v(4) }}>Presiona + para crear una</Text>
                    </View>
                  ) : (
                          ...
                          <View style={styles.itemContent}>
                            ...
                            {item.type === 'tarea' && item.tasks && item.tasks.length > 0 && (
                              <Text style={[styles.itemPreview, { fontSize: s(11), color: "#737373", marginTop: v(4) }]} numberOfLines={1}>
                                ☑ {item.tasks[0]}
                                {item.tasks.length > 1 ? ` +${item.tasks.length - 1} más` : ''}
                              </Text>
                            )}
