...
// const TimerScreen = () => {
//   // ✅ Usar el hook - stats tiene los datos reales
//   const { stats, addPomodoro, addBreak } = useTimerStats();
...
//   // ❌ ELIMINADOS: pomodorosToday, totalTimeToday, breaksToday
...
//   // ✅ handleComplete AHORA SOLO llama a addPomodoro/addBreak
//   // Los datos se guardan automáticamente en el hook
//   const handleComplete = () => {
//     Vibration.vibrate(500);
//     if (mode === 'focus') {
//       addPomodoro(selectedTime);  // ✅ Guarda el pomodoro
//       setCompletedPomodoros(prev => prev + 1);
//       setMode('break');
//       setTimeLeft(5 * 60);
//     } else {
//       addBreak();  // ✅ Guarda el break
...
//                       <TouchableOpacity
//                         key={time}
//                         style={[styles.timeOption, !isActive && { opacity: 1 }]}
...
//                 {/* ✅ ESTADÍSTICAS - Usando stats del hook */}
